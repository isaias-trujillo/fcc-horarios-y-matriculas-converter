...
import { fixMyString } from "../types/mapRawToParsedFichas";
import type Horario from "../types/Horario";
import Turn from "../types/Turn.ts";

const path = "src/horarios-4-de-abril.xlsx";
...
Bun.write("parsed/horarios.json", JSON.stringify(rows, null, 4)).then((r) =>
  console.log(r),
);
